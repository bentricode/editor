<template>
    <div class="control-group">
        ...
        <div class="button-group">
            ...
            <button @click="props.editor.chain().focus().undo().run()"
            ...
            <button @click="props.editor.chain().focus().redo().run()"
            ...
            <HeadingDropdown :editor="props.editor" />
            <button @click="props.editor.chain().focus().toggleBold().run()"
            ...
            <button @click="props.editor.chain().focus().toggleItalic().run()"
            ...
            <button @click="props.editor.chain().focus().toggleStrike().run()"
            ...
            <button @click="props.editor.chain().focus().toggleCode().run()"
            ...
            <!-- <button @click="props.editor.chain().focus().unsetAllMarks().run()">Clear marks</button>
            <button @click="props.editor.chain().focus().clearNodes().run()">Clear nodes</button> -->


            <AlignDropdown :editor="props.editor" />
            <ListDropdown :editor="props.editor" />

            <button @click="props.editor.chain().focus().toggleCodeBlock().run()"
            ...
            <button @click="props.editor.chain().focus().toggleBlockquote().run()"
            ...
            <!-- <button @click="props.editor.chain().focus().setHorizontalRule().run()">Horizontal rule</button> -->
            <!-- <button @click="props.editor.chain().focus().setHardBreak().run()">Hard break</button> -->

            <!-- <button @click="props.editor.chain().focus().setColor('#958DF1').run()"
                :class="{ 'is-active': props.editor.isActive('textStyle', { color: '#958DF1' }) }">
                Purple
            </button> -->
            <button v-tippy="$t('header.image_upload')" @click="addUploadBlock">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <LinkDropdown :editor="props.editor" />
